...
iostat -dkx | sed -e'1,3d' > /home/recaple/io.txt
k=$(wc -l /home/recaple/io.txt | awk '{print $1;}')
count=1
while [ $count -lt $k ]
do
echo "<tr>"
cat /home/recaple/io.txt | head -n$count | tail -n1 | awk  '{ for(i=1; i<14; i++){ print ("<td>" $i "</td>")}}' 
echo "<td>"
res=$(cat  /home/recaple/io.txt | head -n$count | tail -n1 | awk '{print $14}')
pygmentize $res
echo "</td>"
echo "</tr>"
count=$(( $count + 1 ))
